...
create table shoppingbasket(
	...
	member_no number(10) constraint health_fk4 references health_member,
...
create table orderation(
	...
	product_no number(10) constraint health_fk5 references product not null,
	...
	orderation_price number(10) not null,
...
create table orderer(
	...
	member_no number(10) constraint health_fk7 references health_member,
